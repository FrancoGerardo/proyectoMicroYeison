...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{-- @can('Modo Admin') --}}
            <a class="btn btn-dark" href="{{ route('categorias.create') }}"><i class="fas fa-shoe-prints"></i> Registrar
                Categoria</a>
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped table-bordered shadow-lg mt-4" id="tallas">
                ...
                <tbody>
                    @foreach ($categorias as $categoria) {{-- hereeeeee --}}
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('categorias.destroy', $categoria) }}" method="POST">
                                    <a class="btn btn-dark btn-sm" href="{{ route('categorias.edit', $categoria) }}"><i
